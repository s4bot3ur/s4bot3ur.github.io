(() => {
  ...
  // ns-params:@params
  var params_default = { author: { avatar: "/images/avatar.png", bio: "Web3 Security Researcher", company: "Team Bi0s", location: "Bharat", name: "Komal Rao", social: { github: "s4bot3ur", linkedin: "dheekonda-komal-rao-6bb68727b", medium: "s4bot3ur" } }, baseURL: "http://localhost:1313/", breadcrumb: true, carouselpostcount: 5, color: "auto", comment: false, counttaxonomyposts: false, customcss: [], customjs: [], dateformat: ":date_long", diagram: false, docsnav: { reducefontsize: true }, featuredpostcount: 5, fixedheader: true, fontsize: { extralarge: "1.2rem", extrasmall: ".8rem", large: "1.1rem", small: ".9rem" }, fullwidth: false, mainsections: ["blogs", "docs"], palette: "blue", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 1, post: { featuredimage: true, post: { copyright: false } }, postdate: true, poweredby: true, readingtime: true, recentpostcount: 5, relatedpostcount: 5, sass_transpiler: "libsass", searchbar: true, sidebar: { featuredposts: true, logo: "/images/logo.webp", recentposts: false }, sidebartaxonomies: ["categories", "tags", "series"], social: { email: "s4bot3ur.x.t0r4n4d0@gmail.com", github: "s4bot3ur", twitter: "s4bot3ur" }, taxonomypaginate: 10, taxonomypostcount: 3, titlecase: false, titleseparator: "-", tocwordcount: 280, viewer: true };
